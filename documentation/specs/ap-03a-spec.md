# Story: heise.de Suche

## User Story

Als Rechercheurin möchte ich automatisiert nach Keyword-Paaren auf heise.de suchen und eine vollständige Liste aller passenden Artikel (Titel, Link, Datum) erhalten, damit ich keine relevanten Artikel auf heise.de übersehe.

## Beschreibung

Der Crawler nutzt die eingebaute Suchfunktion von heise.de, um für jedes der 17 Keyword-Paare alle Treffer zu finden. Die beiden Begriffe werden als UND-Verknüpfung gesucht. Pagination wird vollständig durchlaufen. Der Datumsfilter wird im Code angewendet.

## Akzeptanzkriterien

### Suche

- [ ] Für ein gegebenes Keyword-Paar wird eine Suchanfrage an heise.de gestellt
...
- Kein Scraping der Artikel-Detailseiten — das ist AP3b
- Keine Paywall-Behandlung — das ist AP3c
